...
<div className="head">
  <H1 id="dict">Spark Dictionary</H1>
  <p>
...
<H1 id="bootcamp" text="Bootcamp">
  <div className="rank rank_boot pull-left"></div>
...
<H1 id="noob" text="Spark Noob">
  <div className="rank rank_noob pull-left"></div>
...
<H1 id="junior" text="Spark Junior">
  <div className="rank rank_junior pull-left"></div>
...
<H1 id="veteran" text="Spark Veteran">
  <div className="rank rank_veteran pull-left"></div>
